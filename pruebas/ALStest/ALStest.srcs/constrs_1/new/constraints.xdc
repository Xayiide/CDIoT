...
# LEDs
set_property PACKAGE_PIN U16 [get_ports {als_d[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {als_d[0]}]
set_property PACKAGE_PIN E19 [get_ports {als_d[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {als_d[1]}]
set_property PACKAGE_PIN U19 [get_ports {als_d[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {als_d[2]}]
set_property PACKAGE_PIN V19 [get_ports {als_d[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {als_d[3]}]
set_property PACKAGE_PIN W18 [get_ports {als_d[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {als_d[4]}]
set_property PACKAGE_PIN U15 [get_ports {als_d[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {als_d[5]}]
set_property PACKAGE_PIN U14 [get_ports {als_d[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {als_d[6]}]
set_property PACKAGE_PIN V14 [get_ports {als_d[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {als_d[7]}]
set_property PACKAGE_PIN V13 [get_ports {rcv_d[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rcv_d[0]}]
set_property PACKAGE_PIN V3 [get_ports {rcv_d[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rcv_d[1]}]
set_property PACKAGE_PIN W3 [get_ports {rcv_d[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rcv_d[2]}]
set_property PACKAGE_PIN U3 [get_ports {rcv_d[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rcv_d[3]}]
set_property PACKAGE_PIN P3 [get_ports {rcv_d[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rcv_d[4]}]
set_property PACKAGE_PIN N3 [get_ports {rcv_d[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rcv_d[5]}]
set_property PACKAGE_PIN P1 [get_ports {rcv_d[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rcv_d[6]}]
set_property PACKAGE_PIN L1 [get_ports {rcv_d[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rcv_d[7]}]
...
set_property PACKAGE_PIN J1 [get_ports {uss_n}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {uss_n}]
##Bank = 35, Pin name = ,					Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {umiso}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {umiso}]
##Bank = 35, Pin name = ,					Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {usclk}]					
...
set_property PACKAGE_PIN A14 [get_ports {urx}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {urx}]
##Bank = , Pin name = ,					Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {utx}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {utx}]
