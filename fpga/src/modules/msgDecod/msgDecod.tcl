...
#
# msgDecod.tcl: Tcl script for re-creating project 'msgDecod'
#
# Generated by Vivado on Sun Jun 20 18:43:39 +0200 2021
...
#
# 1. This project restoration tcl script (msgDecod.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/xam/Documents/GitHub/CDIoT/fpga/src/modules/msgDecod/msgDecod.srcs/sources_1/new/msgDecod.vhd"
#
...
set orig_proj_dir "[file normalize "$origin_dir/msgDecod"]"
...
set files [list \
 [file normalize "${origin_dir}/msgDecod/msgDecod.srcs/sources_1/new/msgDecod.vhd" ]\
]
...
set_property -name "top" -value "msgDecod" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/msgDecod.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/msgDecod.srcs/utils_1/imports/impl_1" -objects $obj
